...
h0 = figure('Color',screencol,'HitTest','off', ...
    ...
    'Name','      Digital Grain Size GUI [Version 4.0 (June 2013)].', ...
...
h1 = uicontrol('Parent',h0,'units','normalized', ...
    ...
    'string',{'DGS GUI v4.0. Dan Buscombe, USGS, June 2013'}, ...
    'tag','instructions');
...
=======
    'YDir','normal','ZColor',[1 1 1]);
>>>>>>> 3e8fb1db7228ea8e7d2cf088ce0277a8043171d9
